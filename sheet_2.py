...
class TearOffCalendarSheet(TearOffCalendarBaseSheet):
    ...
    def draw(self, cal_data = None):
        ...
        self.draw_day(self.draw[self.i], self.cal_data['day'], 235, 'Molot.otf', 130)
        ...
        self.draw_moon_info(self.draw[self.BLACK], self.cal_data['moon_info'], 'Заход\n{}\nВосход\n{}\n{}\nд. {}', 272, 239, 'moon_phases.ttf', 18, 'r-10', 260, 'Cuprum-Regular.ttf', 14)
        self.draw_constellation(self.draw[self.BLACK], self.cal_data['moon_info']['constellation'], 370, 'Cuprum-Italic.ttf', 16)
