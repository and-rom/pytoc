...
class TearOffCalendarSheet(TearOffCalendarBaseSheet):
    ...
    def draw(self, cal_data = None):
        ...
        pageBlack.paste(signal, (1, 2), wifi)
        ...
        draw[0].text((9, y-4), '\U00002609', font=sun_font, fill='black')
        ...
        draw[0].text((274, y-1), self.MOON_PHASES[cal_data['moon_phase_id']][0], font=moon_font, fill='black')
        ...
        draw[0].text((10, y+20), s, font=sm_font, fill='black')
        m_w, m_h = draw[0].textsize(m, font=sm_font)
        draw[0].text((self.page_w-10-m_w, y+20), m, font=sm_font, align='right')
        ...
        draw[0].text((10, self.page_h-location_name_h-2), cal_data['location_name'], font=location_name_font)
        ...
        if self.backpage_name != '':
            ...
            draw[0].text((self.page_w-backpage_name_w-10, self.page_h-backpage_name_h-2), self.backpage_name, font=backpage_name_font)
